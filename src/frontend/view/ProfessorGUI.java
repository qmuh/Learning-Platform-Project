...
public class ProfessorGUI extends PageNavigator implements ProfessorCommands
{
	...
	private void createDiscussionPage(Course course)
	{
		...
		//myEmailsPage.setEnrollmentPageButtonListener(
		//		new EnrollmentButtonListener(myEmailsPage, course));
	...
	private class SendButtonListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			if( response == JOptionPane.OK_OPTION)
			{
				...
				try
				{
					Boolean h = (Boolean) clientController.sendMessage(new SendMessage<EmailInfo>(mailInfo, CMD_EMAIL));
					if(h == true)
					{
